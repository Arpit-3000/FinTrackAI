...
const categories = {
  ...
  expense: [
    ...
    { id: 'healthcare', name: 'Healthcare', icon: 'medical', iconType: 'ionicons', color: colors.chartRed },
    { id: 'education', name: 'Education', icon: 'school', iconType: 'ionicons', color: colors.info },
    { id: 'groceries', name: 'Groceries', icon: 'cart', iconType: 'ionicons', color: colors.chartGreen },
